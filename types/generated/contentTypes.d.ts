...
export interface ApiInsightInsight extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploads: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
  };
}
...
export interface ApiWhitepaperWhitepaper extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whitework: Schema.Attribute.String;
  };
}
...
export interface ApiWhoWeAreWhoWeAre extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ITService: Schema.Attribute.String;
    LABs: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
